...
myForm.addEventListener('click', function(e){
  e.preventDefault()
    ...
    submit_btn.addEventListener("click", function(){
        ...
        submit_btn.parentElement.parentElement.parentElement.parentElement.parentElement.style.display = 'none';
        if(keys == '' || values == ""){
            alert('The Field Text Cannot be blank ');
            submit_btn.parentElement.parentElement.parentElement.parentElement.parentElement.style.display = 'block';
